...
export default function FootballField({
  ...
  return (
    <div className="relative w-full aspect-[3.2/4] bg-field-texture border border-emerald-900/60 rounded-2xl overflow-hidden shadow-inner select-none max-w-2xl mx-auto">
      ...
      {/* Render 11 vị trí cầu thủ trên sân */}
      {coordinates.map((pos, idx) => {
        ...
        return (
          ...
          >
            {player ? (
              // Trạng thái: Đã chọn cầu thủ vào vị trí
              <div className="relative flex flex-col items-center">
                {/* Nút Xoá cầu thủ khỏi vị trí */}
                <button
                ...
                {/* Tên cầu thủ hiển thị dưới thẻ */}
                <div className="mt-1 bg-black/85 backdrop-blur-sm border border-gray-800 text-white text-[9px] md:text-xs font-semibold py-0.5 px-1.5 rounded-full text-center max-w-[85
